...
pub struct Phase {
    ...
    #[serde(alias = "nixPackages", skip_serializing_if = "Option::is_none")]
    pub nix_pkgs: Option<Vec<String>>,

    #[serde(alias = "nixLibraries", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(alias = "aptPackages", skip_serializing_if = "Option::is_none")]
    pub apt_pkgs: Option<Vec<String>>,

    #[serde(alias = "commands", skip_serializing_if = "Option::is_none")]
    pub cmds: Option<Vec<String>>,

    #[serde(rename = "onlyIncludeFiles", skip_serializing_if = "Option::is_none")]
    pub only_include_files: Option<Vec<String>>,

    #[serde(rename = "cacheDirectories", skip_serializing_if = "Option::is_none")]
    pub cache_directories: Option<Vec<String>>,

    #[serde(alias = "envPaths", skip_serializing_if = "Option::is_none")]
